            ...
            <NewFolderDialog setOpen={setOpenNewFolder} />
					...
					<MenubarMenu>
						...
						<MenubarContent>
							...
							<MenubarCheckboxItem className="text-xs" checked>
								Show Lyrics
							</MenubarCheckboxItem>
							<MenubarSeparator />
							...
							<MenubarSeparator />
							<MenubarItem className="text-xs" inset>
								Hide Sidebar
							</MenubarItem>
					...
					<MenubarMenu>
						...
						<MenubarContent forceMount>
							<MenubarLabel inset className="text-xs">
								Switch Account
							</MenubarLabel>
							<MenubarSeparator />
							<MenubarRadioGroup value="benoit">
								<MenubarRadioItem className="text-xs" value="andy">
									Andy
								</MenubarRadioItem>
								<MenubarRadioItem className="text-xs" value="benoit">
									Benoit
								</MenubarRadioItem>
								<MenubarRadioItem className="text-xs" value="Luis">
									Luis
								</MenubarRadioItem>
							</MenubarRadioGroup>
							<MenubarSeparator />
